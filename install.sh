...
c=n d=n h=n i=n I=n l=n r=n s=n u=n w=n v=n BRANCH=x14 SERVICE=web
...
function setup_chatwoot() {
  ...
  git clone https://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@github.com/xfiv-tech/chatwoot.git
  cd chatwoot
  git checkout "$BRANCH"
  bundle
  yarn
